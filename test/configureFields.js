...
module.exports.tests.sourceExcluded = function(test, common) {
  ...
  test('sourceExcluded fields are appended to _source excludes', function(t) {
    const mapping = configureFields(document, { sourceExcludedFields: ['addendum', 'parent.*_a', 'shape'] });
...
module.exports.tests.unmapped = function(test, common) {
  test('unmapped fields are removed from mapping', function(t) {
    const mapping = configureFields(document, { unmappedFields: ['popularity', 'parent.county_a', 'not_a_field'] });
  ...
  test('original mapping is not modified', function(t) {
    configureFields(document, { sourceExcludedFields: ['addendum'], unmappedFields: ['popularity', 'parent.county_a'] });
