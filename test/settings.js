...
module.exports.tests.peliasKeyword = function (test, common) {
  test('has pelias keyword normalizer', function (t) {
    var s = settings();
    t.equal(typeof s.analysis.normalizer.peliasKeyword, 'object', 'there is a pelias keyword normalizer');
    var normalizer = s.analysis.normalizer.peliasKeyword;
