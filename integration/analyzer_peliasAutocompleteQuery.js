...
module.exports.tests.analyze = function(test, common){
  test( 'analyze', function(t){
    ...
    var assertAnalysis = analyze.bind( null, suite, t, 'peliasAutocompleteQuery' );
...
module.exports.tests.today = function(test, common){
  test( 'today', function(t){
    ...
    assertAnalysis( 'foo', 'noe valley', [
      'noe', 'valley'
    ]);

    assertAnalysis( 'foo2', 'union square', [
      'union', 'square'
    ]);

    assertAnalysis( 'foo3', 'foo lane', [
      'foo', 'lane'
    ]);
...
module.exports.tests.functional = function(test, common){
  test( 'functional', function(t){
    ...
    var expected1 = [ '325', 'north', '12th', 'street' ];
    assertAnalysis( '325 N 12th St', '325 N 12th St', expected1 );
    assertAnalysis( '325 North 12th Street', '325 North 12th Street', expected1 );

    // both terms should map to same tokens
    var expected2 = [ '13509', 'colfax', 'avenue', 'south' ];
    assertAnalysis( '13509 Colfax Ave S', '13509 Colfax Ave S', expected2 );
    assertAnalysis( '13509 Colfax Avenue South', '13509 Colfax Avenue South', expected2 );

    // both terms should map to same tokens
    var expected3 = [ '100', 'south', 'lake', 'dr' ];
    assertAnalysis( '100 S Lake Dr', '100 S Lake Dr', expected3 );
    assertAnalysis( '100 South Lake Drive', '100 South Lake Drive', expected3 );

    // both terms should map to same tokens
    var expected4 = [ '100', 'northwest', 'highway' ];
    assertAnalysis( '100 northwest highway', '100 northwest highway', expected4 );
    assertAnalysis( '100 nw hwy', '100 nw hwy', expected4 );
...
module.exports.all = function (tape, common) {
  ...
  function test(name, testFunction) {
    return tape('peliasAutocompleteQuery: ' + name, testFunction);
  }
