  ...
  test('source filter', function (t) {
    ...
    suite.action(function (done) {
      suite.client.index({
        ...
        id: '1',
        body: { source: 'osm', layer: 'node', source_id: 'dataset/1' }
      }, done)
    })
    ...
    suite.action(function (done) {
      suite.client.index({
        ...
        type: config.schema.typeName,
        id: '2',
        body: { source: 'osm', layer: 'address', source_id: 'dataset/2' }
      }, done)
    })
    ...
    suite.action(function (done) {
      suite.client.index({
        ...
        type: config.schema.typeName,
        id: '3',
        body: { source: 'geonames', layer: 'address', source_id: 'dataset/1' }
      }, done)
    })
